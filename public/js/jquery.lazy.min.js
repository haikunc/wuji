    ...
    e.fn.lazy = function(i) {
        ...
        function p() {
            ...
            if (s.delay < 0 || s.combined) {
                d(false);
                x(function() {
                    e(s.appendScroll).bind("scroll", b(s.throttle, function() {
                        x(function() {
                            d(false)
                        }, this, true)
                    }))
                ...
                x(function() {
                    e(s.appendScroll).bind("resize", b(s.throttle, function() {
                        a = f =- 1;
                        x(function() {
                            d(false)
                        }, this, true)
        ...
        function v(n, r) {
            ...
            i.one("load", function() {
                var e = function() {
                    ...
                    n.hide();
                    if (r == "img")
                        n.attr("src", i.attr("src"));
                    else 
                        n.css("background-image", "url(" + i.attr("src") + ")");
        ...
        function m(e) {
            var t = g(), n = y(), r = e.getBoundingClientRect(), i = n + s.threshold > r.top&&-s.threshold < r.bottom, o = t + s.threshold > r.left&&-s.threshold < r.right;
        ...
        var s = {
            ...
            onError: null,
            onFinishedAll: null
        }, o = this, u = 0, a =- 1, f =- 1, l = null, c = [], h = false;
        (function() {
            if (i)
                e.extend(s, i);
            if (s.onError)
